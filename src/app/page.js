  ...
  return (
    <div className="poll-card" onClick={onClick}>
      <div className="poll-card-header">
        ...
        {poll.poll_type === 'prediction' && <span className="prediction-badge">🎯 ทำนายอนาคต</span>}
        ...
        <div className="modal-overlay" onClick={() => setSelectedPoll(null)}>
          <div className="modal" style={{ maxWidth: '550px' }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ marginBottom: '1rem' }}>
              ...
              {selectedPoll.poll_type === 'prediction' && <span className="prediction-badge" style={{ marginLeft: '0.5rem' }}>🎯 ทำนายอนาคต</span>}

      ...
      <div className={`modal info-modal ${darkMode ? 'dark' : ''}`} onClick={e => e.stopPropagation()}>
        ...
        <div className="info-modal-content">
          ...
          <div className="info-card">
            ...
            <p>ไปที่ "บัญชีของฉัน" แล้วกดปุ่ม "กรอกข้อมูลเพื่อสร้างโพลได้" กรอกชื่อจริง วันเกิด เพศ(ไม่บังคับ) และยอมรับเงื่อนไข PDPA</p>
          </div>
          
          <div className="info-card verified-info-card">
            <h4>✓ Verified Badge</h4>
            <p>Badge ✓ คือสัญญาณของความน่าเชื่อถือ ซึ่งได้จากการมีส่วนร่วมอย่างสม่ำเสมอในระบบ</p>
